...
async def update_student_details(student_id:str,
    ...
    return await Students.update_student_details(student_id,student_name,year,mail,gender,password)

@app.put("/student_profile",summary = "Update the student profile")
