...
from controllers.login_controller import LoginController, RefreshTokenController,LogoutController,protected_users
...
@app.get("/protected",summary = "Protected routes only for admins", dependencies=[Depends(security)])
@handle_exception
